...
QSlider::handle:horizontal {
    background: #2A82DA; border: 1px solid #2A82DA; width: 12px; margin: -5px 0; border-radius: 6px;
}
...
class AudioGenerationWorker(QObject):
    ...
    def run(self):
        ...
        try:
            ...
            use_chunking = p.duration > MAX_CHUNK_S
...
class AudioLDM2Studio(QMainWindow):
    ...
    def save_audio(self):
        ...
        path, _ = QFileDialog.getSaveFileName(
            self, "Save Audio", default_name, "WAV Audio (*.wav)"
        )
        if path:
            try:
    ...
    def show_about(self):
        QMessageBox.about(self, "About",
            ...
            f"<p>A pure GUI for AudioLDM2 text-to-audio generation.</p>")
